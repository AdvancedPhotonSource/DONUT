...
data = np.load('/data/aileen/DONUT_data/sim_sample.npy')
...
np.save(os.path.join(folder, 'strain_fit_SIO_fig2.npy'), strain_cpu)
np.save(os.path.join(folder, 'tilt_lr_fit_SIO_fig2.npy'), tilt_lr_cpu)
np.save(os.path.join(folder, 'tilt_ud_fit_SIO_fig2.npy'), tilt_ud_cpu)